 ...
 */
public class TimeToWordsEnglish {
    ...
    public TimeToWordsEnglish() {
        this.width = characters[0].length;
        this.height = characters.length;
        this.characterArray = new Character[height][width];
        setCharacterArray();
    }
        ...
        for (int i = 0; i < height; i++) {
            for (int j = 0; j < width; j++) {
                if ((i == 9) && (j == 5)) {
                    ...
                    characterArray[i][j] =
                            new Character((char) 0x01A0);
                } else {
                    characterArray[i][j] = new Character(
                            characters[i][j]);
                }
            }
        }
